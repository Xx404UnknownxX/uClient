...
public class GuiOtherSettingsOF extends GuiScreen
{
    ...
    private static EnumOptions[] enumOptions = new EnumOptions[] {EnumOptions.LAGOMETER, EnumOptions.PROFILER, EnumOptions.WEATHER, EnumOptions.TIME, EnumOptions.USE_FULLSCREEN, EnumOptions.FULLSCREEN_MODE, EnumOptions.USE_SERVER_TEXTURES, EnumOptions.AUTOSAVE_TICKS, EnumOptions.ANAGLYPH};
