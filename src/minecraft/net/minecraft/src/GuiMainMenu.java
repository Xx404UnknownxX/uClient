...
public class GuiMainMenu extends GuiScreen
{
    ...
    {
        this.buttonList.add(new GuiCustomButton(1, this.width / 2 - 200, 120, par3StringTranslate.translateKey("menu.singleplayer")));
        this.buttonList.add(new GuiCustomButton(2, this.width / 2 - 200, 140, par3StringTranslate.translateKey("menu.multiplayer")));
        this.buttonList.add(new GuiCustomButton(0, this.width / 2 - 200, 160, par3StringTranslate.translateKey("menu.options")));
        this.buttonList.add(new GuiCustomButton(4, this.width / 2 - 200, 180, par3StringTranslate.translateKey("menu.quit")));
        this.buttonList.add(new GuiCustomButton(13, this.width / 2 - 200, 200, par3StringTranslate.translateKey("Update")));
    }
    ...
    {
        this.buttonList.add(new GuiCustomButton(11, this.width / 2 - 100, par1, par3StringTranslate.translateKey("menu.playdemo")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 13)
        {
            ...
            try {
                ...
                java.net.URI uri = new java.net.URI("https://dl.dropbox.com/u/156006561/uClient.jar");
                desktop.browse( uri );
            }
            catch ( Exception e ) {
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        int var11 = 540;
        int var12 = 220;
        this.drawRect(261, 120, var11, var12, 0x80808080);
        this.drawString(this.fontRenderer, "§auClient §fMade By §3Xx404_UnknowxX §f- §eMinecraft 1.5.1", 262, 122, 0xffffff);
        this.drawString(this.fontRenderer, "v1.0 -=- Made The Client.", 262, 134, 0xffffff);
        this.drawString(this.fontRenderer, "Warning! Go Into Maximum Window Size! -Xx404_UnknowxX", 262, 144, 0xffffff);
