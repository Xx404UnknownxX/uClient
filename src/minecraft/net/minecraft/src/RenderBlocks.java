...
public class RenderBlocks
{
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        float var14 = 0.0F;
        boolean var15 = true;
        int var16 = par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4);
        Tessellator var17 = Tessellator.instance;
        var17.setBrightness(983055);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 - 1, par4, 0))
        {
            ...
            var18 = Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3 - 1, par4)];
            var21 = Block.canBlockGrass[this.blockAccess.getBlockId(par2, par3 - 1, par4 + 1)];
            var20 = Block.canBlockGrass[this.blockAccess.getBlockId(par2, par3 - 1, par4 - 1)];
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2, par3 - 1, par4);
            var11 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXYNN + this.aoLightValueScratchYZNP + var22) / 4.0F;
            var14 = (this.aoLightValueScratchYZNP + var22 + this.aoLightValueScratchXYZPNP + this.aoLightValueScratchXYPN) / 4.0F;
            var13 = (var22 + this.aoLightValueScratchYZNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNN) / 4.0F;
            var12 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNN + var22 + this.aoLightValueScratchYZNN) / 4.0F;
            ...
            this.colorRedTopLeft *= var11;
            this.colorGreenTopLeft *= var11;
            this.colorBlueTopLeft *= var11;
            this.colorRedBottomLeft *= var12;
            this.colorGreenBottomLeft *= var12;
            this.colorBlueBottomLeft *= var12;
            this.colorRedBottomRight *= var13;
            this.colorGreenBottomRight *= var13;
            this.colorBlueBottomRight *= var13;
            this.colorRedTopRight *= var14;
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 + 1, par4, 1))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2, par3 + 1, par4);
            var14 = (this.aoLightValueScratchXYZNPP + this.aoLightValueScratchXYNP + this.aoLightValueScratchYZPP + var22) / 4.0F;
            var11 = (this.aoLightValueScratchYZPP + var22 + this.aoLightValueScratchXYZPPP + this.aoLightValueScratchXYPP) / 4.0F;
            var12 = (var22 + this.aoLightValueScratchYZPN + this.aoLightValueScratchXYPP + this.aoLightValueScratchXYZPPN) / 4.0F;
            var13 = (this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPN + var22 + this.aoLightValueScratchYZPN) / 4.0F;
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2, par3, par4 - 1);
            var11 = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN + var22 + this.aoLightValueScratchYZPN) / 4.0F;
            var12 = (var22 + this.aoLightValueScratchYZPN + this.aoLightValueScratchXZPN + this.aoLightValueScratchXYZPPN) / 4.0F;
            var13 = (this.aoLightValueScratchYZNN + var22 + this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXZPN) / 4.0F;
            var14 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXZNN + this.aoLightValueScratchYZNN + var22) / 4.0F;
            ...
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
            var24 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 2);
            ...
            if (var8 && fancyGrass && var24.getIconName().equals("grass_side") && !this.hasOverrideBlockTexture())
            {
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 + 1, 3))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2, par3, par4 + 1);
            var11 = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP + var22 + this.aoLightValueScratchYZPP) / 4.0F;
            var14 = (var22 + this.aoLightValueScratchYZPP + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYZPPP) / 4.0F;
            var13 = (this.aoLightValueScratchYZNP + var22 + this.aoLightValueScratchXYZPNP + this.aoLightValueScratchXZPP) / 4.0F;
            var12 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXZNP + this.aoLightValueScratchYZNP + var22) / 4.0F;
            ...
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
            var24 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 3);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 - 1, par3, par4, 4))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2 - 1, par3, par4);
            var14 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNP + var22 + this.aoLightValueScratchXZNP) / 4.0F;
            var11 = (var22 + this.aoLightValueScratchXZNP + this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPP) / 4.0F;
            var12 = (this.aoLightValueScratchXZNN + var22 + this.aoLightValueScratchXYZNPN + this.aoLightValueScratchXYNP) / 4.0F;
            var13 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXYNN + this.aoLightValueScratchXZNN + var22) / 4.0F;
            ...
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
            var24 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 4);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 + 1, par3, par4, 5))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2 + 1, par3, par4);
            var11 = (this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNP + var22 + this.aoLightValueScratchXZPP) / 4.0F;
            var12 = (this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXZPN + var22) / 4.0F;
            var13 = (this.aoLightValueScratchXZPN + var22 + this.aoLightValueScratchXYZPPN + this.aoLightValueScratchXYPP) / 4.0F;
            var14 = (var22 + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYPP + this.aoLightValueScratchXYZPPP) / 4.0F;
            ...
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
            var24 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 5);
    ...
    public boolean func_102027_b(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2, par3, par4 - 1);
            var25 = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN + var22 + this.aoLightValueScratchYZPN) / 4.0F;
            var24 = (var22 + this.aoLightValueScratchYZPN + this.aoLightValueScratchXZPN + this.aoLightValueScratchXYZPPN) / 4.0F;
            var27 = (this.aoLightValueScratchYZNN + var22 + this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXZPN) / 4.0F;
            var26 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXZNN + this.aoLightValueScratchYZNN + var22) / 4.0F;
            var11 = (float)((double)var25 * this.renderMaxY * (1.0D - this.renderMinX) + (double)var24 * this.renderMinY * this.renderMinX + (double)var27 * (1.0D - this.renderMaxY) * this.renderMinX + (double)var26 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
            var12 = (float)((double)var25 * this.renderMaxY * (1.0D - this.renderMaxX) + (double)var24 * this.renderMaxY * this.renderMaxX + (double)var27 * (1.0D - this.renderMaxY) * this.renderMaxX + (double)var26 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX));
            var13 = (float)((double)var25 * this.renderMinY * (1.0D - this.renderMaxX) + (double)var24 * this.renderMinY * this.renderMaxX + (double)var27 * (1.0D - this.renderMinY) * this.renderMaxX + (double)var26 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxX));
            var14 = (float)((double)var25 * this.renderMinY * (1.0D - this.renderMinX) + (double)var24 * this.renderMinY * this.renderMinX + (double)var27 * (1.0D - this.renderMinY) * this.renderMinX + (double)var26 * (1.0D - this.renderMinY) * (1.0D - this.renderMinX));
            var29 = this.getAoBrightness(this.aoBrightnessXZNN, this.aoBrightnessXYZNPN, this.aoBrightnessYZPN, var23);
            var28 = this.getAoBrightness(this.aoBrightnessYZPN, this.aoBrightnessXZPN, this.aoBrightnessXYZPPN, var23);
            var31 = this.getAoBrightness(this.aoBrightnessYZNN, this.aoBrightnessXYZPNN, this.aoBrightnessXZPN, var23);
            var30 = this.getAoBrightness(this.aoBrightnessXYZNNN, this.aoBrightnessXZNN, this.aoBrightnessYZNN, var23);
            this.brightnessTopLeft = this.mixAoBrightness(var29, var28, var31, var30, this.renderMaxY * (1.0D - this.renderMinX), this.renderMaxY * this.renderMinX, (1.0D - this.renderMaxY) * this.renderMinX, (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
            this.brightnessBottomLeft = this.mixAoBrightness(var29, var28, var31, var30, this.renderMaxY * (1.0D - this.renderMaxX), this.renderMaxY * this.renderMaxX, (1.0D - this.renderMaxY) * this.renderMaxX, (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX));
            this.brightnessBottomRight = this.mixAoBrightness(var29, var28, var31, var30, this.renderMinY * (1.0D - this.renderMaxX), this.renderMinY * this.renderMaxX, (1.0D - this.renderMinY) * this.renderMaxX, (1.0D - this.renderMinY) * (1.0D - this.renderMaxX));
            this.brightnessTopRight = this.mixAoBrightness(var29, var28, var31, var30, this.renderMinY * (1.0D - this.renderMinX), this.renderMinY * this.renderMinX, (1.0D - this.renderMinY) * this.renderMinX, (1.0D - this.renderMinY) * (1.0D - this.renderMinX));
            ...
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
            var32 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 2);

            if (var9)
            {
                var32 = this.fixAoSideGrassTexture(var32, par2, par3, par4, 2, par5, par6, par7);
            }

            this.renderEastFace(par1Block, (double)par2, (double)par3, (double)par4, var32);

            if (var8 && fancyGrass && var32.getIconName().equals("grass_side") && !this.hasOverrideBlockTexture())
            {
                this.colorRedTopLeft *= par5;
                this.colorRedBottomLeft *= par5;
                this.colorRedBottomRight *= par5;
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 + 1, 3))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2, par3, par4 + 1);
            var25 = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP + var22 + this.aoLightValueScratchYZPP) / 4.0F;
            var24 = (var22 + this.aoLightValueScratchYZPP + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYZPPP) / 4.0F;
            var27 = (this.aoLightValueScratchYZNP + var22 + this.aoLightValueScratchXYZPNP + this.aoLightValueScratchXZPP) / 4.0F;
            var26 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXZNP + this.aoLightValueScratchYZNP + var22) / 4.0F;
            var11 = (float)((double)var25 * this.renderMaxY * (1.0D - this.renderMinX) + (double)var24 * this.renderMaxY * this.renderMinX + (double)var27 * (1.0D - this.renderMaxY) * this.renderMinX + (double)var26 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
            var12 = (float)((double)var25 * this.renderMinY * (1.0D - this.renderMinX) + (double)var24 * this.renderMinY * this.renderMinX + (double)var27 * (1.0D - this.renderMinY) * this.renderMinX + (double)var26 * (1.0D - this.renderMinY) * (1.0D - this.renderMinX));
            var13 = (float)((double)var25 * this.renderMinY * (1.0D - this.renderMaxX) + (double)var24 * this.renderMinY * this.renderMaxX + (double)var27 * (1.0D - this.renderMinY) * this.renderMaxX + (double)var26 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxX));
            var14 = (float)((double)var25 * this.renderMaxY * (1.0D - this.renderMaxX) + (double)var24 * this.renderMaxY * this.renderMaxX + (double)var27 * (1.0D - this.renderMaxY) * this.renderMaxX + (double)var26 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX));
            var29 = this.getAoBrightness(this.aoBrightnessXZNP, this.aoBrightnessXYZNPP, this.aoBrightnessYZPP, var23);
            var28 = this.getAoBrightness(this.aoBrightnessYZPP, this.aoBrightnessXZPP, this.aoBrightnessXYZPPP, var23);
            var31 = this.getAoBrightness(this.aoBrightnessYZNP, this.aoBrightnessXYZPNP, this.aoBrightnessXZPP, var23);
            var30 = this.getAoBrightness(this.aoBrightnessXYZNNP, this.aoBrightnessXZNP, this.aoBrightnessYZNP, var23);
            this.brightnessTopLeft = this.mixAoBrightness(var29, var30, var31, var28, this.renderMaxY * (1.0D - this.renderMinX), (1.0D - this.renderMaxY) * (1.0D - this.renderMinX), (1.0D - this.renderMaxY) * this.renderMinX, this.renderMaxY * this.renderMinX);
            this.brightnessBottomLeft = this.mixAoBrightness(var29, var30, var31, var28, this.renderMinY * (1.0D - this.renderMinX), (1.0D - this.renderMinY) * (1.0D - this.renderMinX), (1.0D - this.renderMinY) * this.renderMinX, this.renderMinY * this.renderMinX);
            this.brightnessBottomRight = this.mixAoBrightness(var29, var30, var31, var28, this.renderMinY * (1.0D - this.renderMaxX), (1.0D - this.renderMinY) * (1.0D - this.renderMaxX), (1.0D - this.renderMinY) * this.renderMaxX, this.renderMinY * this.renderMaxX);
            this.brightnessTopRight = this.mixAoBrightness(var29, var30, var31, var28, this.renderMaxY * (1.0D - this.renderMaxX), (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX), (1.0D - this.renderMaxY) * this.renderMaxX, this.renderMaxY * this.renderMaxX);
            ...
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
            var32 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 3);

            if (var9)
            {
                var32 = this.fixAoSideGrassTexture(var32, par2, par3, par4, 3, par5, par6, par7);
            }

            this.renderWestFace(par1Block, (double)par2, (double)par3, (double)par4, var32);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 - 1, par3, par4, 4))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2 - 1, par3, par4);
            var25 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNP + var22 + this.aoLightValueScratchXZNP) / 4.0F;
            var24 = (var22 + this.aoLightValueScratchXZNP + this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPP) / 4.0F;
            var27 = (this.aoLightValueScratchXZNN + var22 + this.aoLightValueScratchXYZNPN + this.aoLightValueScratchXYNP) / 4.0F;
            var26 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXYNN + this.aoLightValueScratchXZNN + var22) / 4.0F;
            var11 = (float)((double)var24 * this.renderMaxY * this.renderMaxZ + (double)var27 * this.renderMaxY * (1.0D - this.renderMaxZ) + (double)var26 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ) + (double)var25 * (1.0D - this.renderMaxY) * this.renderMaxZ);
            var12 = (float)((double)var24 * this.renderMaxY * this.renderMinZ + (double)var27 * this.renderMaxY * (1.0D - this.renderMinZ) + (double)var26 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ) + (double)var25 * (1.0D - this.renderMaxY) * this.renderMinZ);
            var13 = (float)((double)var24 * this.renderMinY * this.renderMinZ + (double)var27 * this.renderMinY * (1.0D - this.renderMinZ) + (double)var26 * (1.0D - this.renderMinY) * (1.0D - this.renderMinZ) + (double)var25 * (1.0D - this.renderMinY) * this.renderMinZ);
            var14 = (float)((double)var24 * this.renderMinY * this.renderMaxZ + (double)var27 * this.renderMinY * (1.0D - this.renderMaxZ) + (double)var26 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ) + (double)var25 * (1.0D - this.renderMinY) * this.renderMaxZ);
            var29 = this.getAoBrightness(this.aoBrightnessXYNN, this.aoBrightnessXYZNNP, this.aoBrightnessXZNP, var23);
            var28 = this.getAoBrightness(this.aoBrightnessXZNP, this.aoBrightnessXYNP, this.aoBrightnessXYZNPP, var23);
            var31 = this.getAoBrightness(this.aoBrightnessXZNN, this.aoBrightnessXYZNPN, this.aoBrightnessXYNP, var23);
            var30 = this.getAoBrightness(this.aoBrightnessXYZNNN, this.aoBrightnessXYNN, this.aoBrightnessXZNN, var23);
            this.brightnessTopLeft = this.mixAoBrightness(var28, var31, var30, var29, this.renderMaxY * this.renderMaxZ, this.renderMaxY * (1.0D - this.renderMaxZ), (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ), (1.0D - this.renderMaxY) * this.renderMaxZ);
            this.brightnessBottomLeft = this.mixAoBrightness(var28, var31, var30, var29, this.renderMaxY * this.renderMinZ, this.renderMaxY * (1.0D - this.renderMinZ), (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ), (1.0D - this.renderMaxY) * this.renderMinZ);
            this.brightnessBottomRight = this.mixAoBrightness(var28, var31, var30, var29, this.renderMinY * this.renderMinZ, this.renderMinY * (1.0D - this.renderMinZ), (1.0D - this.renderMinY) * (1.0D - this.renderMinZ), (1.0D - this.renderMinY) * this.renderMinZ);
            this.brightnessTopRight = this.mixAoBrightness(var28, var31, var30, var29, this.renderMinY * this.renderMaxZ, this.renderMinY * (1.0D - this.renderMaxZ), (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ), (1.0D - this.renderMinY) * this.renderMaxZ);
            ...
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
            var32 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 4);

            if (var9)
            {
                var32 = this.fixAoSideGrassTexture(var32, par2, par3, par4, 4, par5, par6, par7);
            }

            this.renderNorthFace(par1Block, (double)par2, (double)par3, (double)par4, var32);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 + 1, par3, par4, 5))
        {
            ...
            var22 = par1Block.getAmbientOcclusionLightValue(this.blockAccess, par2 + 1, par3, par4);
            var25 = (this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNP + var22 + this.aoLightValueScratchXZPP) / 4.0F;
            var24 = (this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXZPN + var22) / 4.0F;
            var27 = (this.aoLightValueScratchXZPN + var22 + this.aoLightValueScratchXYZPPN + this.aoLightValueScratchXYPP) / 4.0F;
            var26 = (var22 + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYPP + this.aoLightValueScratchXYZPPP) / 4.0F;
            var11 = (float)((double)var25 * (1.0D - this.renderMinY) * this.renderMaxZ + (double)var24 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ) + (double)var27 * this.renderMinY * (1.0D - this.renderMaxZ) + (double)var26 * this.renderMinY * this.renderMaxZ);
            var12 = (float)((double)var25 * (1.0D - this.renderMinY) * this.renderMinZ + (double)var24 * (1.0D - this.renderMinY) * (1.0D - this.renderMinZ) + (double)var27 * this.renderMinY * (1.0D - this.renderMinZ) + (double)var26 * this.renderMinY * this.renderMinZ);
            var13 = (float)((double)var25 * (1.0D - this.renderMaxY) * this.renderMinZ + (double)var24 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ) + (double)var27 * this.renderMaxY * (1.0D - this.renderMinZ) + (double)var26 * this.renderMaxY * this.renderMinZ);
            var14 = (float)((double)var25 * (1.0D - this.renderMaxY) * this.renderMaxZ + (double)var24 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ) + (double)var27 * this.renderMaxY * (1.0D - this.renderMaxZ) + (double)var26 * this.renderMaxY * this.renderMaxZ);
            var29 = this.getAoBrightness(this.aoBrightnessXYPN, this.aoBrightnessXYZPNP, this.aoBrightnessXZPP, var23);
            var28 = this.getAoBrightness(this.aoBrightnessXZPP, this.aoBrightnessXYPP, this.aoBrightnessXYZPPP, var23);
            var31 = this.getAoBrightness(this.aoBrightnessXZPN, this.aoBrightnessXYZPPN, this.aoBrightnessXYPP, var23);
            var30 = this.getAoBrightness(this.aoBrightnessXYZPNN, this.aoBrightnessXYPN, this.aoBrightnessXZPN, var23);
            this.brightnessTopLeft = this.mixAoBrightness(var29, var30, var31, var28, (1.0D - this.renderMinY) * this.renderMaxZ, (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ), this.renderMinY * (1.0D - this.renderMaxZ), this.renderMinY * this.renderMaxZ);
            this.brightnessBottomLeft = this.mixAoBrightness(var29, var30, var31, var28, (1.0D - this.renderMinY) * this.renderMinZ, (1.0D - this.renderMinY) * (1.0D - this.renderMinZ), this.renderMinY * (1.0D - this.renderMinZ), this.renderMinY * this.renderMinZ);
            this.brightnessBottomRight = this.mixAoBrightness(var29, var30, var31, var28, (1.0D - this.renderMaxY) * this.renderMinZ, (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ), this.renderMaxY * (1.0D - this.renderMinZ), this.renderMaxY * this.renderMinZ);
            this.brightnessTopRight = this.mixAoBrightness(var29, var30, var31, var28, (1.0D - this.renderMaxY) * this.renderMaxZ, (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ), this.renderMaxY * (1.0D - this.renderMaxZ), this.renderMaxY * this.renderMaxZ);
            ...
            this.colorGreenTopRight *= var14;
            this.colorBlueTopRight *= var14;
            var32 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 5);

            if (var9)
            {
                var32 = this.fixAoSideGrassTexture(var32, par2, par3, par4, 5, par5, par6, par7);
            }

            this.renderSouthFace(par1Block, (double)par2, (double)par3, (double)par4, var32);
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 - 1, par4, 0))
        {
            var10.setBrightness(this.renderMinY > 0.0D ? var28 : par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3 - 1, par4));
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 + 1, par4, 1))
        {
            var10.setBrightness(this.renderMaxY < 1.0D ? var28 : par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3 + 1, par4));
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 - 1, 2))
        {
            var10.setBrightness(this.renderMinZ > 0.0D ? var28 : par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4 - 1));
            var10.setColorOpaque_F(var20, var23, var26);
            var29 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 2);

            if (var9)
            {
                if (var29 == TextureUtils.iconGrassSide || var29 == TextureUtils.iconMycelSide)
                {
                    var29 = Config.getSideGrassTexture(this.blockAccess, par2, par3, par4, 2, var29);

                    if (var29 == TextureUtils.iconGrassTop)
                    {
                        var10.setColorOpaque_F(var20 * par5, var23 * par6, var26 * par7);
                    }
                }

                if (var29 == TextureUtils.iconSnowSide)
                {
            ...
            if (var8 && fancyGrass && var29.getIconName().equals("grass_side") && !this.hasOverrideBlockTexture())
            {
                var10.setColorOpaque_F(var20 * par5, var23 * par6, var26 * par7);
                this.renderEastFace(par1Block, (double)par2, (double)par3, (double)par4, BlockGrass.getIconSideOverlay());
            }
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 + 1, 3))
        {
            var10.setBrightness(this.renderMaxZ < 1.0D ? var28 : par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4 + 1));
            var10.setColorOpaque_F(var20, var23, var26);
            var29 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 3);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 - 1, par3, par4, 4))
        {
            var10.setBrightness(this.renderMinX > 0.0D ? var28 : par1Block.getMixedBrightnessForBlock(this.blockAccess, par2 - 1, par3, par4));
            var10.setColorOpaque_F(var21, var24, var27);
            var29 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 4);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 + 1, par3, par4, 5))
        {
            var10.setBrightness(this.renderMaxX < 1.0D ? var28 : par1Block.getMixedBrightnessForBlock(this.blockAccess, par2 + 1, par3, par4));
            var10.setColorOpaque_F(var21, var24, var27);
            var29 = this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 5);
    ...
    public static boolean renderItemIn3d(int par0)
    {
        switch (par0)
        {
            ...
            case 38:
            default:
                return Reflector.ModLoader.exists() ? Reflector.callBoolean(Reflector.ModLoader_renderBlockIsItemFull3D, new Object[] {Integer.valueOf(par0)}): false;
        }
    }
